...
use App\Repositories\Admin\BusinessLocationRepositoriy;
...
class BusinessLocationController extends Controller {
	protected $request;
	protected $repo;
	public function __construct(Request $request, BusinessLocationRepositoriy $repo) {
	...
	public function index() {
		...
		return view('admin.business_location.index');
	}
	...
	public function create() {
		...
		return view('admin.business_location.create', $pre_requisite);
	}
	...
	public function store(BusinessLocationRequest $request) {
		...
		return response()->json(['message' => __('service.created_successfull', ['attribute' => __('page.business_location')])]);
	}
	...
	public function show($id) {
		...
		return view('admin.business_location.show', compact('model'));
	}
	...
	public function edit($id) {
		...
		return view('admin.business_location.edit', compact('model'), $pre_requisite);
	}
	...
	public function update(BusinessLocationRequest $request, $id) {
		...
		return response()->json(['message' => __('service.updated_successfull', ['attribute' => __('page.business_location')])]);
	}
	...
	public function destroy($id) {
		...
		if ($this->request->action and $this->request->action == 'status') {
			...
			return response()->json(['message' => __('service.status_updated', ['attribute' => __('page.business_location')])]);
		}
		$this->repo->deletable($id);
		$this->repo->delete($model);
		return response()->json(['message' => __('service.deleted', ['attribute' => __('page.business_location')])]);
	...
	public function action() {
		...
		if (!$this->request->ids or !count($this->request->ids)) {
			throw ValidationException::withMessages(['message' => trans_choice('service.multiple_deleted', 0, ['attribute' => __('page.business_location')])]);
		}
	...
	public function checkLocationId() {
		...
		return response()->json(['message' => __('service.available', ['attribute' => __('page.business_location')])]);
