...
use App\Http\Requests\GroupTaxRequest;
use App\Repositories\Admin\GroupTaxRepositoriy;
...
class GroupTaxController extends Controller {
	protected $request;
	protected $repo;
	public function __construct(Request $request, GroupTaxRepositoriy $repo) {
	...
	public function index() {
		...
		return view('admin.group_taxes.index');
	}
	...
	public function create() {
		...
		return view('admin.group_taxes.create', $pre_requisite);
	}
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function store(GroupTaxRequest $request) {
		if (!auth()->user()->can('tax_rate.create')) {
			abort(403, 'Unauthorized action.');
		}
	...
	public function show($id) {
		...
		// return view('admin.group_taxes.show', compact('model'));
	}
	...
	public function edit($id) {
		...
		return view('admin.group_taxes.edit', compact('model'), $pre_requisite);
	}
	 ...
	 * @return \Illuminate\Http\Response
	 */
	public function update(GroupTaxRequest $request, $id) {
