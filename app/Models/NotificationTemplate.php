...
class NotificationTemplate extends Model {
	...
	public static function customerNotifications() {
		return [
			'new_sale' => ['name' => __('service.new_sale')],
			'payment_received' => ['name' => __('service.payment_received')],
			'payment_reminder' => ['name' => __('service.payment_reminder')],
			'new_booking' => [
				'name' => __('service.new_booking'),
	...
	public static function supplierNotifications() {
		return [
			'new_order' => ['name' => __('service.new_order')],
			'payment_paid' => ['name' => __('service.payment_paid')],
			'items_received' => ['name' => __('service.items_received')],
			'items_pending' => ['name' => __('service.items_pending')],
		];
	}
