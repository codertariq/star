...
class SellingPriceGroupRepositoriy extends Repository {
	public function __construct(SellingPriceGroup $model) {
		$this->model = $model;
		$this->permission = '';
		$this->route = 'admin.selling-price-group.';
		$this->action_exeption = ['show'];
	}
	/**
	 * Get model query
	 *
	 * @return SellingPriceGroup query
	 */
	...
	public function selectAll() {
		return $this->model->all()->pluck('name', 'id')->prepend(__('service.select', ['attribute' => __('page.selling_price_group')]), '');
	}
	/**
	...
	public function findOrFail($id, $field = 'message') {
		...
		if (!$model) {
			throw ValidationException::withMessages([$field => __('service.not_found', ['attribute' => __('page.selling_price_group')])]);
		}
		return $model;
	}
	/**
	...
	public function datatable() {
		...
		return Datatables::of($models)
			...
			->addColumn('action', function ($model) {
				...
				return view('admin.selling_price_group.action', compact('model', 'action'));
	 ...
	 * Update given model.
	 *
	 * @param SellingPriceGroup $model
	 * @param array $params
	 *
	 * @return SellingPriceGroup
	 */
	public function update(SellingPriceGroup $model, $params) {
	 ...
	 * @return bool|null
	 */
	public function delete(SellingPriceGroup $model) {
		return $model->delete();
	}
	/**
	...
	public function deleteMultiple($ids) {
		...
		$msg = trans_choice('service.multiple_deleted', count($ids), ['attribute' => __('page.selling_price_group'), 'value' => count($ids)]);
		return $msg;
	}
