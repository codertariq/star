...
$data['breadcrumbs'] = 'customer-group.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-collaboration';
$data['page'] = __('page.customer_group');
$data['page_title'] = __('page.customer_group_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.customer-group.';
$data['page_index'] = 'admin.customer-group.index';
@endphp
			...
			<table class="table content_management_datatable table-striped" data-url="@if(isset($data['route']) and Route::has($data['route'].'create')){{ route($data['route'].'index', ['get' => 'datatable']) }}@endif">
				<thead>
					<tr>
						<th></th>
						<th>#</th>
						<th>@lang( 'service.customer_group_name' )</th>
						<th>@lang( 'service.calculation_percentage' )</th>
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/customer_group.js') }}"></script>
@endpush