...
$data['breadcrumbs'] = 'products.edit';
$data['create'] = 'link';
$data['icon'] = 'fa fa-file';
$data['page'] = __('page.product');
$data['page_title'] = __('page.update', ['attribute' => gv($data, 'page', __('page.home'))]);
$data['permission'] = 'user.';
$data['route'] = 'admin.products.';
$data['page_index'] = 'admin.products.edit';
@endphp
...
@section('page_header')
{{ Breadcrumbs::render(gv($data, 'breadcrumbs', 'home'), $model) }}
@stop
@section('content')
<div class="content">
	{!! Form::model($model, ['route' => [$data['route'].'update', $model->id], 'class' => 'form-validate-jquery product_form', 'id' => 'product_form', 'method' => 'PUT', 'files' => true]) !!}
	<fieldset class="mb-3">
						...
						<div class="row">
							<div class="col-sm-4 @if(!session('business.enable_brand')) hide @endif">
								<div class="form-group">
									...
									<div class="input-group">
										{!! Form::select('brand_id', $brands, $model->brand_id , ['data-placeholder' => __('messages.please_select'), 'class' => 'form-control select', 'id' => 'brand_id']); !!}
							...
							<div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
								<div class="form-group">
									...
									{!! Form::select('category_id', $categories, $model->category_id , ['data-placeholder' => __('messages.please_select'), 'class' => 'form-control select']); !!}
								</div>
							</div>
							<div class="col-sm-4 @if(!session('business.enable_category') and !session('business.enable_brand')) hide @endif">
								<div class="form-group">
									...
									{!! Form::select('model_id', $models, $model->model_id, ['data-placeholder' => __('messages.please_select'), 'class' => 'form-control select']); !!}
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									data-element="form"><i class="fa fa-plus-circle text-primary fa-lg"></i></span></label>
									<div class="input-group">
										{!! Form::select('unit_id', $units,  $model->unit_id , ['class' => 'form-control select', 'required', 'data-placeholder' => 'Please Select', 'id' => 'unit_id']); !!}
									</div>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									...
									{!! Form::select('barcode_type', $barcode_types, $model->barcode_type, ['class' => 'form-control select', 'required']); !!}
								</div>
							</div>
								...
								<div class="form-group">
									<div class="form-check form-check-inline">
										<label class="form-check-label">
											{!! Form::checkbox('enable_stock', 1, $model->enable_stock,
											[ 'class' => 'form-check-input-styled', 'data-fouc', 'id' => 'enable_stock']) !!}  @lang('product.manage_stock')
										</label>
									</div>
								</div>
							</div>
							<div class="col-sm-4" @if(!$model->enable_stock) style="display:none;" @endif id="alert_quantity_div">
								<div class="form-group">
									{!! Form::label('alert_quantity',  __('product.alert_quantity') . ':*') !!} @show_tooltip(__('tooltip.alert_quantity'))
									{!! Form::number('alert_quantity', $model->alert_quantity , ['class' => 'form-control', 'required',
						...
						<div class="row">
							<div class="col-sm-8">
								<div class="form-group">
									...
									{!! Form::textarea('product_description', $model->product_description , ['class' => 'form-control summernote']); !!}
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
          ...
          @endif
					<div class="col-sm-4 @if($hide) hide @endif">
						<div class="form-group">
							<div class="multi-input">
								...
								{!! Form::text('expiry_period', @num_format($model->expiry_period), ['class' => 'form-control pull-left input_number',
								'placeholder' => __('product.expiry_period'), 'style' => 'width:60%;']); !!}
								{!! Form::select('expiry_period_type', ['months'=>__('product.months'), 'days'=>__('product.days'), '' =>__('product.not_applicable') ], $model->expiry_period_type , ['class' => 'form-control select pull-left', 'style' => 'width:40%;', 'id' => 'expiry_period_type']); !!}
							</div>
						</div>
					</div>
					@endif
					<div class="col-sm-4">
						<div class="form-group">
							<div class="form-check form-check-inline">
								<label class="form-check-label">
									{!! Form::checkbox('enable_sr_no', 1, $model->enable_sr_no,
					...
					<div class="col-sm-4">
						<div class="form-group">
							<div class="form-check form-check-inline">
								<label class="form-check-label">
									{!! Form::checkbox('is_lifetime', 1, $model->is_lifetime,
					...
					@php
					$warenty_period = 12;
					$hide = $model->is_lifetime ? true : false;
					@endphp
					<div class="col-sm-4 @if($hide) hide @endif" id="warenty_row">
						<div class="form-group">
							<div class="form-group">
								...
								<div class="input-group">
									{!! Form::text('warenty_period', $model->warenty_period, ['class' => 'form-control pull-left input_number', 'placeholder' => __('product.warenty_period'), 'style' => 'width:40%;']); !!}
									<span class="input-group-append">
										{!! Form::select('warenty_period_type', ['months'=>__('product.months'), 'days'=>__('product.days'), '' =>__('product.not_applicable') ],  $model->warenty_period_type, ['class' => 'form-control select pull-left', 'style' => 'width:60%;', 'id' => 'warenty_period_type']); !!}
									</span>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="form-group">
							...
							{!! Form::text('weight',  $model->weightl, ['class' => 'form-control', 'placeholder' => __('service.weight')]); !!}
						</div>
					</div>
					@endif
					<!--custom fields-->
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							...
							{!! Form::text('product_custom_field1', $model->product_custom_field1, ['class' => 'form-control', 'placeholder' => __('service.product_custom_field1')]); !!}
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							{!! Form::label('product_custom_field2',  __('service.product_custom_field2') . ':') !!}
							{!! Form::text('product_custom_field2', $model->product_custom_field2, ['class' => 'form-control', 'placeholder' => __('service.product_custom_field2')]); !!}
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							{!! Form::label('product_custom_field3',  __('service.product_custom_field3') . ':') !!}
							{!! Form::text('product_custom_field3', $model->product_custom_field3 , ['class' => 'form-control', 'placeholder' => __('service.product_custom_field3')]); !!}
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							{!! Form::label('product_custom_field4',  __('service.product_custom_field4') . ':') !!}
							{!! Form::text('product_custom_field4', $model->product_custom_field4 , ['class' => 'form-control', 'placeholder' => __('service.product_custom_field4')]); !!}
						</div>
					</div>
					<!--custom fields-->
				</div>
				...
				<div class="row">
					<div class="col-sm-4 @if(!session('business.enable_price_tax')) hide @endif">
						<div class="form-group">
							...
							{!! Form::select('tax', $taxes, $model->tax , ['data-placeholder' => __('messages.please_select'), 'class' => 'form-control select'], $tax_attributes); !!}
						</div>
					</div>
					<div class="col-sm-4 @if(!session('business.enable_price_tax')) hide @endif">
						<div class="form-group">
							product
							{!! Form::select('tax_type', ['inclusive' => __('product.inclusive'), 'exclusive' => __('product.exclusive')], $model->tax_type ,
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							...
							{!! Form::select('type', ['single' => __('service.single'), 'variable' => __('service.variable')], $model->type , ['class' => 'form-control select',
                  'required','disabled', 'data-action' => 'edit', 'data-product_id' => $model->id ]); !!}
						</div>
					</div>
