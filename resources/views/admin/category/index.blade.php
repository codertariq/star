...
$data['breadcrumbs'] = 'categories.index';
$data['create'] = 'modal';
$data['icon'] = 'fa fa-tag';
$data['page'] = __('page.category');
$data['page_title'] = __('page.category_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.categories.';
$data['page_index'] = 'admin.categories.index';
@endphp
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/category.js') }}"></script>
@endpush