...
$data['breadcrumbs'] = 'invoice-schemes.index';
$data['create'] = 'modal';
$data['icon'] = 'fa fa-file';
$data['page'] = __('page.invoice_schemes');
$data['page_title'] = __('page.invoice_schemes_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.invoice-schemes.';
$data['page_index'] = 'admin.invoice-schemes.index';
@endphp
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/invoice_schemes.js') }}"></script>
@endpush