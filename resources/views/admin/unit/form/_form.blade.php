    ...
    <div class="form-group col-sm-12">
      <div class="form-check form-check-inline">
        <label class="form-check-label">
          {!! Form::checkbox('define_base_unit', 1 , false,[ 'class' => 'form-check-input-styled toggler', 'data-toggle_id' => 'base_unit_div', 'data-fouc']) !!}@lang( 'service.add_as_multiple_of_base_unit' )
