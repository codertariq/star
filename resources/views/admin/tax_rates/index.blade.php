...
$data['breadcrumbs'] = 'tax-rates.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-pushpin';
$data['page'] = __('page.tax_rates');
$data['page_title'] = __('page.tax_rates_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.tax-rates.';
$data['page_index'] = 'admin.tax-rates.index';
@endphp
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/tax_rates.js') }}"></script>
@endpush