...
$data['breadcrumbs'] = 'business-location.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-location4';
$data['page'] = __('page.business_location');
$data['page_title'] = __('page.business_location_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.business-location.';
$data['page_index'] = 'admin.business-location.index';
@endphp
			...
			<table class="table content_management_datatable table-striped" data-url="@if(isset($data['route']) and Route::has($data['route'].'create')){{ route($data['route'].'index', ['get' => 'datatable']) }}@endif">
				<thead>
					<tr>
						...
						<th>@lang( 'service.location_id' )</th>
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/business_location.js') }}"></script>
@endpush