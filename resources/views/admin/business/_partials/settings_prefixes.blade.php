     <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[purchase]', __('service.purchase_order') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[purchase_return]', __('service.purchase_return') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[stock_transfer]', __('service.stock_transfer') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[sell_return]', __('service.sell_return') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[purchase_payment]', __('service.purchase_payment') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[sell_payment]', __('service.sell_payment') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[expense_payment]', __('service.expense_payment') . ':') !!}
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                @endphp
                {!! Form::label('ref_no_prefixes[subscription]', __('service.subscription_no') . ':') !!}
