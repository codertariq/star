...
$data['breadcrumbs'] = 'group-taxes.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-make-group';
$data['page'] = __('page.group_taxes');
$data['page_title'] = __('page.group_taxes_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.group-taxes.';
$data['page_index'] = 'admin.group-taxes.index';
@endphp
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/group_taxes.js') }}"></script>
@endpush