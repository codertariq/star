...
$data['breadcrumbs'] = 'selling-price-group.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-lan2';
$data['page'] = __('page.selling_price_group');
$data['page_title'] = __('page.selling_price_group_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.selling-price-group.';
$data['page_index'] = 'admin.selling-price-group.index';
@endphp
			...
			<table class="table content_management_datatable table-striped" data-url="@if(isset($data['route']) and Route::has($data['route'].'create')){{ route($data['route'].'index', ['get' => 'datatable']) }}@endif">
				<thead>
					<tr>
						...
						<th>@lang( 'service.description' )</th>
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/selling_price_group.js') }}"></script>
@endpush