...
$data['breadcrumbs'] = 'models.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-color-sampler';
$data['page'] = __('page.model');
$data['page_title'] = __('page.model_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.models.';
$data['page_index'] = 'admin.models.index';
@endphp
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/model.js') }}"></script>
@endpush