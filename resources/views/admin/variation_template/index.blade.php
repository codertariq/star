...
$data['breadcrumbs'] = 'variation-templates.index';
$data['create'] = 'modal';
$data['icon'] = 'icon-color-sampler';
$data['page'] = __('page.variation_template');
$data['page_title'] = __('page.variation_template_title');
$data['permission'] = 'user.';
$data['route'] = 'admin.variation-templates.';
$data['page_index'] = 'admin.variation-templates.index';
@endphp
...
@stop
@push('js')
<script src="{{ asset('js/pages/admin/variation_template.js') }}"></script>
@endpush